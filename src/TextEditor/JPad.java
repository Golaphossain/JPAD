...
public class JPad extends JFrame implements ActionListener, ManueCreate {
    ...
    //FindClass findReplaceDialog = null;
    ...
    JPad() {
        ...
        textarea = new JTextPane(new KeywordDocument(defaultStyle, kwStyle));//new JTextArea(30, 60);
       ...
       // statusBar = new JLabel("||       Ln 1, Col 1  ", JLabel.RIGHT);
        ...
        //fram.add(statusBar, BorderLayout.SOUTH);
...
///////////////////////////////////
    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        if (cmdText.equals(fileNew)) {
            ...
            JOptionPane.showMessageDialog(JPad.this.fram, aboutText, "Dedicated 2 u!", JOptionPane.INFORMATION_MESSAGE);
